...
export WANDB_API_KEY='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'
...
EXPERIMENT_NAME='simplevla-rl-training-3A100-batch48' 
...
SFT_MODEL_PATH="/workspace/openvla_model"
CKPT_PATH="/workspace/checkpoints"
...
NUM_NODES=1 
ALIGN_PATH="/workspace/SimpleVLA-RL/align.json"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.val_micro_batch_size=6 \
