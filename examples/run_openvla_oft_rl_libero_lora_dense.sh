...
TASK_SAMPLING_MODE="${TASK_SAMPLING_MODE:-balanced_hard}"
...
TASK_SAMPLING_LOG_TRAIN_TASKS="${TASK_SAMPLING_LOG_TRAIN_TASKS:-False}"
...
export TASK_SAMPLING_ENABLED TASK_SAMPLING_MODE TASK_SAMPLING_UNIFORM_FRACTION
export TASK_SAMPLING_MIN_TASK_PROBABILITY TASK_SAMPLING_EMA_MOMENTUM
export TASK_SAMPLING_DEFAULT_SUCCESS TASK_SAMPLING_SEED TASK_SAMPLING_LOG_TRAIN_TASKS
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    data.task_sampling.mode=$TASK_SAMPLING_MODE \
    ...
    data.task_sampling.log_train_tasks=$TASK_SAMPLING_LOG_TRAIN_TASKS \
